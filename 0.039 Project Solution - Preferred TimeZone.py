#0.039. Project Solution - Preferred TimeZone
...
try:
    a = Account('123','John','Albert', '-7:00')
except ValueError as e:
    print(e)
#Output:-TimeZone must be a valid timezone object.

b = Account('123','Rudra','Singh')
